...
schema = [
    ...
    Table(
        ...
        Column("obec_prez", Integer, nullable=False),
    ...
    Table(
        ...
        Column("plat_str", Text, nullable=False),
    ...
    Table(
        ...
        Column("typ_form", Integer, nullable=True),
        Column("oprava", Integer, nullable=True),
        Column("chyba", Integer, nullable=True),
        Column("kraj", Integer, nullable=True),
        Column("okres", Integer, nullable=False),
        Column("obec", Integer, nullable=False),
        Column("okrsek", Integer, nullable=False),
        ...
        Column("posl_kand", Integer, nullable=True),
    ...
    Table(
        ...
        Column("preskoceni", String(1), nullable=False),
    ...
    Table(
        ...
        Column("typvs", Text, nullable=True),
    ...
    Table(
        ...
        meta,
        Column("datum", Date, nullable=False),
        Column("id_okrsky", SmallInteger, nullable=False),
        Column("typ_form", SmallInteger, nullable=True),
        Column("oprava", SmallInteger, nullable=True),
        Column("chyba", SmallInteger, nullable=True),
        Column("kraj", SmallInteger, nullable=True),
        Column("okres", SmallInteger, nullable=False),
        Column("obec", Integer, nullable=False),
        Column("okrsek", Integer, nullable=False),
        Column("kc_1", Integer, nullable=True),
        ...
        Column("kc_2", Integer, nullable=True),
        Column("zakrstrana", bitmap_ish(99), nullable=True),
        UniqueConstraint("datum", "okres", "obec", "okrsek"),
    ),
    Table(
        "kraje_okrsky_hlasy",
        ...
        Column("kc_3", Integer, nullable=True),
        Column("kc_4", Integer, nullable=True),
        Column("kc_5", Integer, nullable=True),
        Column("posl_kand", SmallInteger, nullable=True),
        Column("kc_sum", Integer, nullable=True),
        Column("hlasy", array_ish, nullable=False),
        UniqueConstraint("datum", "okres", "obec", "okrsek", "kstrana"),
    ...
    Table(
        ...
        Column("plat_str", String(1), nullable=False),
    ...
    Table(
        ...
        Column("nazev_vs", Text, nullable=True),
        UniqueConstraint("datum", "obvod", "ckand"),
    ),
    Table(
        "senat_obvody",
        meta,
        # nullable, protoze u ciselniku povolime NULL pro globalni ciselniky
