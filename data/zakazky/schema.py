...
schema = [
    ...
    Table(
        ...
        meta,
        Column("vz_systemove_cislo", Text, nullable=False),
        Column("nipez_kod", Text, nullable=False),
        Column("nipez_nazev", Text, nullable=False),
        Column("nipez_povinnost_pro_etrziste", Text, nullable=False),
    ...
    Table(
        ...
        Column("druh_zadavaci_rizeni", Text, nullable=False),
        ...
        Column("byla_do_zr_zarazena_eaukce", Text, nullable=False),
        Column("pocet_vyzvanych_dodavatelu", Text, nullable=True),
        Column("pocet_obdrzenych_nabidek", Text, nullable=False),
        Column("pocet_hodnocenych_nabidek", Text, nullable=False),
        Column("namitky_pocet", Text, nullable=False),
        Column("namitky_vyhoveno", Text, nullable=True),
        Column("prezkum_ukonu", Text, nullable=False),
        Column("prezkumnych_rizeni_pocet", Text, nullable=True),
        Column("zadosti_o_dodatecne_informace_pocet", Text, nullable=False),
