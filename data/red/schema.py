...
schema = [
    Table(
        ...
        Column("jmeno_prijmeni", Text, nullable=True),
    ...
    Table(
        ...
        Column("podpis_datum", DateTime, nullable=True),
    ...
    Table(
        ...
        Column("financni_prostredek_cleneni", Text, nullable=False),
    ...
    Table(
        ...
        Column("ucel_znak", Text, nullable=True),
        Column("datum_aktualizace", DateTime, nullable=False),
        Column("datum_exportu", DateTime, nullable=False),
    ),
]
